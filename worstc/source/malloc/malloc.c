  ...
  if ((CHUNK_SIZE_T)(nb) >= (CHUNK_SIZE_T)(av->mmap_threshold) &&
    ...
    */
    ...
    if ((CHUNK_SIZE_T)(size) > (CHUNK_SIZE_T)(nb)) {
      ...
      mm = (char*)(MMAP(0, size, MAP_USER_WRITE, MAP_PRIVATE));
  ...
  */
  ...
  if (brk == (char*)(MORECORE_FAILURE)) {
    ...
    if ((CHUNK_SIZE_T)(size) > (CHUNK_SIZE_T)(nb)) {
      ...
      brk = (char*)(MMAP(0, size, MAP_USER_WRITE, MAP_PRIVATE));
...
#endif
{
  ...
  if (mem != 0) {
    ...
    */
      ...
      VirtualUnmap((uint64_t)p - offset, size + offset);
#endif
    }
  }
}
